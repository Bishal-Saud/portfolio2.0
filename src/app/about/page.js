  ...
  return (
    <>
      ...
      <main className="w-full min-h-screen pt-10 flex flex-col  items-center">
        ...
        <div className="w-2/3 flex justify-between border border-r-8 border-b-8  rounded-3xl h-[50vh] border-[#35374B] ">
          <div className=" w-1/2 p-4 justify-center flex items-center flex-col  border-r-4 rounded-full border-[#35374B]">
            <h2 className="py-5 text-[#FF3EA5]">{"<CODE/>"}</h2>
            <p className=" px-5">
          ...
          <div className="w-1/2 border-l-4 rounded-full border-[#35374B] p-4 flex justify-center items-center flex-col">
            <h2 className="py-5 text-[#54c1cb]"> {"<DESIGN/>"}</h2>
            <p className=" px-5">
